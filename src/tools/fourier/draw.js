...
export function drawCircle(ctx, x, y, r, color = "#ff0000") {
    if (ctx) {
...
export function drawVector(ctx, st, sp) {
...
export function drawLink(ctx, p1, p2) {
    ctx.beginPath();
...
export function drawSolve(ctx, data, k = null, color = null) {
    if (!ctx) {
        return;
    }
    k = k || 1;
